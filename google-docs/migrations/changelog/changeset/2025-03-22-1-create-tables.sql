...
CREATE TABLE "google_tokens" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, "access_token" VARCHAR(2048), "id_token" VARCHAR(2048), "refresh_token" VARCHAR(2048), "scopes" VARCHAR(255), "user_email" VARCHAR(255), CONSTRAINT "google_tokens_pkey" PRIMARY KEY ("id"));
